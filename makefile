GameServer.out: common/all.h game_sync.o server.o main.o player.o room.o socket_error.o common/game_proto.pb.o
	g++ -std=c++11 -g -o GameServer.out game_sync.o server.o main.o player.o room.o socket_error.o -lprotobuf common/game_proto.pb.o
